...
import (
	...
	"github.com/gkwa/nichenew/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.nichenew.yaml)")
